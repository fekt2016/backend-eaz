...
const validateEnv = () => {
  ...
  // err.stack in error responses. Both silently, together.
  //
  // On the reseller plan it comes from cPanel → Setup Node.js App ("Application
  // mode: Production"), so say so loudly if it is missing — this is the last
  // chance to notice before the app serves traffic with those controls off.
